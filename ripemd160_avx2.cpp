...
inline void Initialize(__m256i *s) {
    _mm256_store_si256(s + 0, _mm256_load_si256((const __m256i*)(_init + 0)));
    _mm256_store_si256(s + 1, _mm256_load_si256((const __m256i*)(_init + 8)));
    _mm256_store_si256(s + 2, _mm256_load_si256((const __m256i*)(_init + 16)));
    _mm256_store_si256(s + 3, _mm256_load_si256((const __m256i*)(_init + 24)));
    _mm256_store_si256(s + 4, _mm256_load_si256((const __m256i*)(_init + 32)));
}
